...
#
# 用法: ./scripts/start_nemotron_servers.sh [tensor_parallel_size] [base_port] [cuda_visible_devices] [model_repo_or_local_dir]
# 示例: ./scripts/start_nemotron_servers.sh 2 8001 "0,1,2,3,4,5" "OpenResearcher/OpenResearcher-30B-A3B"
#
